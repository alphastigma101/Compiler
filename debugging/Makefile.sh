...
#g++ -g -std=c++17 -fconcepts -DRADNOM_EXTENSIONS=0 -DENABLE_TESTING=1 $INCLUDE -c ../tests/test_languages.cc -o test_languages.o
#g++ -g -std=c++17 -DRADNOM_EXTENSIONS=0 -DENABLE_TESTING=1 test_languages.o languages.o -o test_languages $LDFLAGS


#echo "Creating debugging object files and executables for token"
g++ -g -std=c++17 -fconcepts -DRADNOM_EXTENSIONS=0 -DENABLE_TESTING=1 $INCLUDE -c ../tokens/token.cc -o token.o
#g++ -g -std=c++17 -DRADNOM_EXTENSIONS=0 -DENABLE_TESTING=1 $INCLUDE -c debug_tokens.cc -o debug_tokens.o
...
g++ -g -std=c++17 -fconcepts -DRADNOM_EXTENSIONS=0 -DENABLE_TESTING=1 $INCLUDE -c ../ast/abstraction_tree_syntax.cc -o abstraction_tree_syntax.o 
g++ -g -std=c++17 -fconcepts -DRADNOM_EXTENSIONS=0 -DENABLE_TESTING=1 $INCLUDE  -c ../debugging/debug_ast.cc -o debug_abstraction_tree_syntax.o 
g++ -g -std=c++17 -fconcepts  -DRADNOM_EXTENSIONS=0 -DENABLE_TESTING=1 parser.o scanner.o abstraction_tree_syntax.o languages.o token.o logging.o debug_abstraction_tree_syntax.o -o exec_debug_abstraction_tree_syntax
